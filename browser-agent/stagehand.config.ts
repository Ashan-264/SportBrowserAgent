...
const StagehandConfig: ConstructorParams = {
  ...
  verbose: 1 /* Enable verbose logging for debugging */,
  env: "BROWSERBASE" as "BROWSERBASE" /* Specify Browserbase environment */,
  ...
  modelName: "Claude-Sonnet-4" /* Name of the model to use */,
  modelClientOptions: {
